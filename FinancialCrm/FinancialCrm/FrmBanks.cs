...
namespace FinancialCrm
{
    public partial class FrmBanks : Form
    {
        ...
        private void FrmBanks_Load(object sender, EventArgs e)
        {
            ...
            var bankProcess2 = db.BankProcesses.OrderByDescending(x => x.BankProcessId).Take(2).Skip(1).FirstOrDefault();//ilk 2 tanesini getir ama 1.yi atla demiş oldum.Yani 1.yi atla bana sadece 2.'yi getir dedim
